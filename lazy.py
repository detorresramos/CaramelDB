...
def lazy_gaussian_elimination(sparse_system, equation_ids, verbose = 0):
    ...
    print("var_to_equations")
    for k, v in var_to_equations.items():
        print(k, v)
    string = ""
    for k in equation_priority:
        string += str(k)
    print("equation_priority")
    print(string)
    string = ""
    for k in variable_weight:
        string += str(k)
    print("variable_weight")
    print(string)
    string = ""
    for k in sorted_variable_ids:
        string += str(k)
    print("sorted_variable_ids")
    print(string)
...
if __name__ == "__main__":
    ...
    test_unsolvable_pair(verbose=0)