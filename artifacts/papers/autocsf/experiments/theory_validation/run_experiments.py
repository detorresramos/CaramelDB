"""Data generation for theory validation. Builds CSFs and saves results to JSON."""
...
from shared.data_gen import compute_actual_alpha, count_minority_keys, gen_alpha_values, gen_keys
...
FILTERS = {
    "xor": {
        ...
        "theory_best_fn": lambda a, n_N, n_f: theory.best_discrete_xor(a, n_N),
    ...
    "binary_fuse": {
        ...
        "param_range": range(1, 9),
        "param_key": "fingerprint_bits",
        "theory_best_fn": lambda a, n_N, n_f: theory.best_discrete_binary_fuse(a, n_N, n_f),
        "measure_kwargs": lambda p: {"fingerprint_bits": p},
    },
    "bloom_k1": {
        "filter_type": "bloom",
        "param_range": range(1, 9),
        "param_key": "bpe",
        "theory_best_fn": lambda a, n_N, n_f: theory.best_discrete_bloom(a, n_N, k=1),
    ...
    "bloom_k2": {
        ...
        "param_range": range(1, 9),
        "param_key": "bpe",
        "theory_best_fn": lambda a, n_N, n_f: theory.best_discrete_bloom(a, n_N, k=2),
        "measure_kwargs": lambda p: {
            "bloom_bits_per_element": p,
            "bloom_num_hashes": 2,
        },
    ...
    "bloom_k3": {
        ...
        "param_range": range(1, 9),
        "param_key": "bpe",
        "theory_best_fn": lambda a, n_N, n_f: theory.best_discrete_bloom(a, n_N, k=3),
        "measure_kwargs": lambda p: {
            "bloom_bits_per_element": p,
            "bloom_num_hashes": 3,
        },
...
def run_alpha_sweep(filter_label, dist):
    ...
    for alpha in tqdm(ALPHAS, desc=f"alpha sweep {filter_label}/{dist}"):
        ...
        n_filter = count_minority_keys(values)
        ...
        best_param, _ = cfg["theory_best_fn"](actual_alpha, n_over_N, n_filter)
